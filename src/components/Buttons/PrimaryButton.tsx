...
export const PrimaryButton = ({ primaryColor, text, paddingY = "4", marginY = "2", width = "200px", clickFunction }: PrimaryButtonProps) => {
  return <button
    className={
    ...
    style={{ backgroundColor: primaryColor, width: width }}
